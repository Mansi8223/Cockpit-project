...
function NewRequests() {
  ...
  return (
    <>
        {newRequest && <div className={`row col-11 d-flex  mt-12 ml-12 mb-12 bg-white border-rounded-16 box-s`}>
            <div className={` col-12 d-flex d-flex-row d-align-center d-justify-space-between m-3`}>
                <div className={` d-flex d-flex-row d-align-start gap-10 h-48`}>
                    <div className={`d-flex d-flex-row d-align-center cursor gap-1  border-bottom-primary`} onClick={()=>{
                        setAllTasks(false)
                        setTemplates(false)
                        setNewRequest(true)}}>
