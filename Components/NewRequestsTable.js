      ...
      <Table size="small" aria-label="a dense table" >
        ...
        <TableBody>
          <TableRow className={`table-body`}>
            ...
            <TableCell align="center"><button className={`btn-secondary-red`}>Pending appr.</button></TableCell>
            <TableCell align="left">5 hours</TableCell>
            <TableCell align="left">8/30/14</TableCell>
            <TableCell align="center"><button className={`btn-view`}><img src='images/entypo_chevron-right.svg' alt='right-icon'/></button></TableCell>
          </TableRow>
        </TableBody>
      </Table>
    </TableContainer>
